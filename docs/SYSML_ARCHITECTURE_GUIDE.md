...
>
> **📝 Note**: This is editable documentation in `docs/`. Generated SysML-derived publications (markdown, diagrams, PDFs) are in `publication/` — these are auto-generated by `make docs` and `make pdf`.
